...
fun MonthDTO.toMonth(): Month {
    return Month(
        ...
        frizior = this.frizior.friziorSub + this.frizior.cosmetic + this.frizior.manikior,
        friziorSub = this.frizior.friziorSub,
        cosmetic = this.frizior.cosmetic,
        manikior = this.frizior.manikior,
